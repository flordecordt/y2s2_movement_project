		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movements",
									"targetURL": "#movementy2s2movementproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"movementy2s2movementproject-display": {
								"semanticObject": "movementy2s2movementproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=movement.y2s2movementproject",
									"url": sap.ui.require.toUrl("movement/y2s2movementproject")
								}
							}
						}
					}
